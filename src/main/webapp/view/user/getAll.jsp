...
<div class="container-fluid">
	...
	<nav class="breadcrumb">
		<span class="breadcrumb-item active"><b>Members List</b></span>
	</nav>
	...
	<table class="table table-sm table-hover">
					...
					<div class="d-flex justify-content-end">
						<div class="btn-toolbar" role="toolbar"
							...
							<div class="btn-group mr-2" role="group" aria-label="First group">
								<a class="btn btn-success btn-sm" href="${user.url}"
									role="button"> <i class="fa fa-edit"></i> Learn More
								</a>
							</div>
		...
		<thead class="thead-default">
			<tr>
				<th class="text-center">Total: <fmt:formatNumber type="number"
						minFractionDigits="0" maxFractionDigits="0"
						value="${totalUserCount}" /></th>
				<th></th>
				<th></th>
			</tr>
		</thead>
