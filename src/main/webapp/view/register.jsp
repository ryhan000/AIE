...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-4">
			<div class="card">
				<h2 class="card-header text-center">check in</h2>
				<div class="card-body">
					...
					<form action="${registerVar}" method="POST">
						...
						<div class="row">
							<div class="col">
								<div class="input-group">
									...
									</span> <input name="username" class="form-control" />
								</div>
							</div>
						</div>
						<p>
						...
						<div class="row">
							<div class="col">
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1"> <i
										class="fa fa-at" style="font-size: 27px;"></i>
									</span> <input name="email" class="form-control" />
								</div>
							</div>
						</div>
						<br>
