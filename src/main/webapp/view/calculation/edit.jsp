...
<title>Caculation No. <c:out value="${calculation.partNumber}" /> behind <fmt:formatDate	value="${calculation.dateStart}" pattern="MMMM" /> <fmt:formatDate	value="${calculation.dateStart}" pattern="yyyy" />
in | <c:out value="${spd.alias}" /> | </title>
		...
		<nav class="breadcrumb">
			<div class="row">
				<div class="col">
					...
					<a class="breadcrumb-item" href="${agreement.url}">Contract <c:out value="${agreement.number}" /></a>
					<a class="breadcrumb-item" href="${specification.url}">Specification No. <c:out value="${specification.specificationNumber}" /> from
														<fmt:formatDate	value="${specification.dateStart}" pattern="dd.MM.yyyy" />in</a>
					<span class="breadcrumb-item active"><b>Calculation No. <c:out value="${calculation.partNumber}" /> behind 
														<fmt:formatDate	value="${calculation.dateStart}" pattern="MMMM" /> <fmt:formatDate	value="${calculation.dateStart}" pattern="yyyy" />
in</b></span>
				</div>
			</div>
			<p>
			<div class="row">
				<div class="col">
					...
					<a class="btn btn-danger" href="${specification.url}" role="button">Cancel</a>
				</div>
			</div>
		</nav>
		...
		<div class="row" >
			<div class="col-4">
				<div class="form-group row">
					<label for="partNumber" class="col-3 col-form-label"><b>Settlement No.</b></label>
					<div class="col-4">
			...
			<div class="col-4">
				<div class="form-group row">
					<label for="dateStart" class="col-5 col-form-label"><b>Calculation period</b></label>
					<div class="col-5">
			...
			<div class="col-3">
				<div class="form-group row">
					<label for="openingBalance" class="col-6 col-form-label"><b>Balance at the beginning</b></label>
					<div class="col-6">
		...
		<div class="row" >
			<div class="col-4">
				<div class="form-group row">
					<label for="salaryRate" class="col-3 col-form-label"><b>Salary</b></label>
					<div class="col-7">
			...
			<div class="col-4">
				<div class="form-group row">
					<label for="withdrawСashСomission" class="col-5 col-form-label"><b>Commission(<fmt:formatNumber type="percent" minFractionDigits="2" maxFractionDigits="2" value="${bankComissionRate}"/>)</b></label>
					<div class="col-7">
						<div class="input-group">
			...
			<div class="col-3">
				<div class="form-group row">
					<label for="simpleTax" class="col-6 col-form-label text-left"><b>Single tax <fmt:formatNumber type="percent" value="${simpleTaxRate}"/></b></label>
					<div class="col-6">
		...
		<div class="row" >
			<div class="col-4">
				<div class="form-group row">
					<label for="premium" class="col-3 col-form-label"><b>Award</b></label>
					<div class="col-7">
						<div class="input-group">
			...
			<div class="col-4">
				<div class="form-group row">
					<label for="cardServiceFee" class="col-5 col-form-label"><b>Maintaining a Card</b></label>
					<div class="col-7">
						<div class="input-group">
		...
		<div class="row" >
			<div class="col-4">
				<div class="form-group row">
					<label for="esv" class="col-3 col-form-label"><b>ERUs</b></label>
					<div class="col-7">
						<div class="input-group">
			...
			<div class="col-4">
				<div class="form-group row">
					<label for="accountServiceFee" class="col-5 col-form-label"><b>Account Management</b></label>
					<div class="col-7">
						<div class="input-group">
		...
		<div class="row" >
			<div class="col-4">
				<div class="form-group row">
					<label for="rent" class="col-3 col-form-label"><b>For rent</b></label>
					<div class="col-7">
						<div class="input-group">
			...
			<div class="col-4">
				<div class="form-group row">
					<label for="bankCost" class="col-5 col-form-label"><b>Total bank. costs:</b></label>
					<div class="col-7">
						<div class="input-group">
		...
		<div class="row" >
			<div class="col-4">
				<div class="form-group row">
					<label for="surcharge" class="col-3 col-form-label"><b>Surcharge </b></label>
					<div class="col-8">
						<div class="input-group">
			...
			<div class="col-3">
				<button onclick="calculationUpdate()" class="btn btn-info btn-block" type="button""><= Calculate=></button>
			</div>
			<div class="col"></div>
			<div class="col-3">
				<div class="form-group row">
					<label for="closingBalance" class="col-6 col-form-label"><b>Balance at the end</b></label>
					<div class="col-6">
		...
		<div class="row" >
			<div class="col-3">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1"><b>&sum; to transfer</b></span>
			...
			<div class="col-3">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1"><b>On hands</b></span>
			...
			<div class="col-3">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1"><b>On the SAP map</b></span>
			...
			<div class="col-3">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1"><b>Withdraw amount</b></span>
