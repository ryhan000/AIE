...
<div class="container-fluid">
	...
	<nav class="breadcrumb">
		<span class="breadcrumb-item active"><b>Entrepreneurs</b></span>
	</nav>
		...
		<div class="col">
			<table class="table table-sm table-hover">
				...
				<c:forEach items="${spds}" var="spd">
					<tr>
						<td class="text-center" onclick="goToAddress('${spd.url}')"><c:out
								value="${spd.id}" /></td>
						<td class="text-center" onclick="goToAddress('${spd.url}')"><c:out
								value="${spd.surname} ${spd.firstname} ${spd.lastname}" /></td>
						<td class="text-center" onclick="goToAddress('${spd.url}')"><c:out
								value="${spd.inn}" /></td>
							...
							<div class="d-flex justify-content-end">
								<div class="btn-toolbar" role="toolbar"
									...
									<div class="btn-group mr-2" role="group"
										...
										<a class="btn btn-success btn-sm" href="${spd.url}"
									...
									<div class="btn-group mr-2" role="group"
										...
										<form action="spd" method="post">
											<input type="hidden" name="delete"> <input
												type="hidden" name="id" value="${spd.id}">
											<sec:csrfInput />
